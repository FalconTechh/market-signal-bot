...
BUILD_ID = "V39-PRO-FOREX-CRYPTO-BINANCE-HYPER-15FX-10CRYPTO-MAHIM-2026-08-31"
...
BINANCE_HOSTS = [h.strip().rstrip("/") for h in
                 (os.getenv("BINANCE_API_HOSTS") or
                  "https://api.binance.com,https://api1.binance.com,https://api2.binance.com,https://api3.binance.com").split(",")
                 if h.strip()]
