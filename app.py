...
@web.get("/")
def home():
    return {"service": "NexCandle AI", "version": "3.2 Market Data Hardened", "status": "online"}

@web.get("/health/data")
def health_data():
    """Non-secret provider diagnostics; performs one lightweight EUR/USD check."""
    result = {"status": "degraded", "configured": {
...
def health():
    ...
    return {"status": "ok", "version": "3.2", "providers": provider,
