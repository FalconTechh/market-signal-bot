...
BUILD_ID = "V31-STABLE-10-PAIRS-30M-1H-2026-08-26"
...
# Backward-compatible alias for the typo seen in the deployed V30 trace
# (NameError: coin_num). Keeping this alias costs nothing and prevents a stale
# helper reference from converting a valid market-data response into HTTP 500.
coin_num = _co_num
