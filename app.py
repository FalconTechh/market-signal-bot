...
def premium_signal_api():
    ...
    allowed_pairs = {"AUD/CHF","AUD/EUR","AUD/JPY","AUD/CAD","AUD/USD","EUR/JPY","EUR/USD","GBP/USD","GBP/JPY","USD/JPY","USD/CHF","USD/CAD","NZD/USD","EUR/GBP"}
    allowed_tf = {"30m","1h"}
...
def health():
    ...
    return {"status": "ok", "version": "V29-30M-1H-CANDLE-FUSION", "bot_mode": BOT_MODE, "providers": provider,
...
def make_v29_signal(pair, tf):
    ...
    if base.get("direction") not in {"UP","DOWN"}:
        raise RuntimeError("Candle structure is not decisive")
    pred="CALL" if base["direction"]=="UP" else "PUT"
    ...
    if samples>=20 and wf < 0.45:
        raise RuntimeError("Candle model calibration is weak")
    ...
    return {
        ...
        "model":"V29 30M/1H Candle Fusion",
