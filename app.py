...
BUILD_ID = "V37-PRO-15PAIRS-20REALCANDLES-1M-5M-1H-MAHIM-2026-08-31"
...
def premium_signal_api():
    ...
    try:
        ...
        if display in {"CALL","PUT"}:
            ...
            # Never turn neutral/conflicted candle evidence into UP just to
            # force a directional response. A clean WAIT is safer than bias.
            s["display_direction"]="WAIT"
            s["display_score"]=0
        ...
        # Public endpoint intentionally exposes only the user-facing signal.
        # Provider names, cache state and internal model diagnostics stay server-side.
        public_signal = {
            "pair": pair,
            "tf": tf,
...
def health():
    ...
    return {"status": "ok", "version": "V37-15-PAIRS-1M-5M-1H-REAL-CANDLE-FIX", "bot_mode": BOT_MODE, "providers": provider,
