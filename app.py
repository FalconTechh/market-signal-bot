...
# ============================================================
# NexCandle AI v3.1 Stable - production-oriented Telegram signal bot
# ============================================================
...
MTF_CACHE_SECONDS = max(5, int(os.getenv("MTF_CACHE_SECONDS", "15")))
...
def health():
    ...
    return {"status": "ok", "version": "3.1", "providers": provider,
...
async def cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await q.message.reply_text(
            ...
            "Fresh market/service data was unavailable or the request timed out. "
            "No fake result was generated.\n\n"
            "Please return to the dashboard and retry.",
